...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-red-900 shadow-md">
      <div className="mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-center">
        ...
        >
          ...
          {/* Search Bar Section */}
          {/* w-full lg:w-50 xl:w-60 lg:shrink-0 mt-4 lg:mt-0 */}
          <div className="w-full lg:w-50 xl:w-60 lg:shrink-0 my-2">
            <SearchBar articles={[]} />
          </div>
        </div>
      </div>
